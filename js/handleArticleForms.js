...
These functions work with the form from the template:
        ...
        <form id="articleForm" onsubmit="return {{formSubmitCall}}">
            ...
            <input type="text" name="author" id="author" value="{{author}}" size="50" title="Article author, max. length 100 characters." maxlength="100" placeholder="napr. JÃ¡n Trieska" />
            <br>
            <label for="title">Title:</label>
            <input type="text" name="title" id="title" value="{{title}}" size="50"  maxlength="100" pattern="\S[\S\s]*" required title="Article title, mandatory item, max. length: 100 characters, the first character must not be a space." placeholder="napr. MÃ´j prvÃ½ prÃ­beh / e.g. My story." />
            <br>
